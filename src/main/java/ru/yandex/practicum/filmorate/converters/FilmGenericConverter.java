...
public class FilmGenericConverter extends AbstractGenericConverter {
    ...
    protected Map<ConvertiblePair, Function<Object, Object>> setSupportConversions() {
        return Map.ofEntries(
                new AbstractMap.SimpleEntry<>(
                        new ConvertiblePair(CreatedFilmDto.class, Film.class),
                        this::convertCreatedFilmDtoToFilm),
                new AbstractMap.SimpleEntry<>(
    ...
    private Film convertCreatedFilmDtoToFilm(Object createdFilmDto) {
        CreatedFilmDto dto = (CreatedFilmDto) createdFilmDto;
        return Film.builder()
                .id(dto.getId())
                .name(dto.getName())
